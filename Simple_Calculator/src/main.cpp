...
void ObtainGuiWidgets(GtkBuilder *p_builder)
{
  ...
  GuiappGET(button_9);
  GuiappGET(button_0);
  GuiappGET(button_plus);
  GuiappGET(button_minus);
  GuiappGET(button_times);
  GuiappGET(button_divide);
  GuiappGET(button_equal);
...
extern "C" void button_plus_clicked(GtkWidget *p_wdgt, gpointer p_data ) 
{
  const char *a_cc_value;
  char c_cc_value[20];
  double a_d_value;
...
extern "C" void button_minus_clicked(GtkWidget *p_wdgt, gpointer p_data ) 
{
  const char *a_cc_value;
  char c_cc_value[20];
  double a_d_value;
...
extern "C" void button_times_clicked(GtkWidget *p_wdgt, gpointer p_data ) 
{
  const char *a_cc_value;
  char c_cc_value[20];
  double a_d_value;
...
extern "C" void button_divide_clicked(GtkWidget *p_wdgt, gpointer p_data ) 
{
  const char *a_cc_value;
  char c_cc_value[20];
  double a_d_value;
